...
-   Create hyptheitical outcome plots (HOPs) by using ungeviz package
...
We can visualize with different like below.  

::: callout-note title="What this code does"
* `.width = 0.95` will plot a 95% interval (a range which 95% of the ditribution lies)
`.point = median`
as central tendency and quantile interval
::
