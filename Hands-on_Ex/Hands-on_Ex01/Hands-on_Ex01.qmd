...
Next, we'll be exploring dot plots (**geom_dotplot**). It's quite similar to bar chart but in dot form instead of a bar.
...
### Changing y and x-axis range in coord object

Changing the range of y and x-axis can be done by specifying *xlim* and *ylim* in the coord object.
...
Themes affects background color, size of fonts, gridline and color of labels. Different themes will affect the look of the graph. In this example, I used the minimal theme:
