...
timeline_nadia <- create_tml_2(df=timeline_nadia_comm, smr="timestamp_desc", dsc="label", dsc2="content", smr_bgcol = "#9A7AA0", smr_col = "white", dsc_col = "#9A7AA0", dsc2_col = "white",
dsc2_bgcol = "peru")
timeline_nadia
```
