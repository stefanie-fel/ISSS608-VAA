...
# Phase 2: Peer Review Visualization

Objective

We are tasked with:

1.  Review a classmate's work

<https://isss608-visualanalytics.netlify.app/take-home_ex/take-home_ex01/take-home_ex01>

what is good about the visualization:
...
-   trend lines and reference line can be confusing as it isn't stated what they represent -\> the trend line and bar chart can be seperated into 2 graph because it might overwhelm reader
-   what is depth (in secodn graph), it's not clearly stated how we can see it in the graph
